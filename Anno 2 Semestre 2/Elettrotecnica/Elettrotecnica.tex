...
\end{center}
Le tensioni di fase $\dot E_1, \dot E_2 \T{ ed } \dot E_3$ sono collegate a stella tra un centro stella $n$ e i terminali 1,2 e 3. Le tensioni concatenate $\dot V_{12}, \dot V_{23} \T{ e } \dot V_{31}$ sono la differenza di potenziale trai terminali 1 e2, 2 e 3 e 3 e 1. Le relazioni tra esse, date dalla LKT, sono:
\begin{align*}
...
\begin{center}
    \begin{tabular}{c c}
        Impedenze a stella connesse a una rete trifase & Impedenze a triangolo connesse a una rete trifase
        \\
