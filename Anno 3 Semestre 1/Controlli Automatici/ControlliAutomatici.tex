...
\vspace*{0.2cm}\\
Per un sistema (tempo invariante continuo) $\dot x(t) = f (x(t), u(t))$ data una coppia di equilibrio $(x_e,u_e)$ vale $f(x_e,u_e)=0$. Se il sistema è non forzato, dato un equilibrio $x_e$ vale $f(x_e)=0$.
